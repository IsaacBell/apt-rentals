...
export default function PromotionalBlock() {
  return (
    <BannerBlock
      ...
      description="Find and book your dream apartment through our cutting-edge service. Or rent a houseboat through our partner app, Charter Fleet, the world's leading boat home comparison site."
