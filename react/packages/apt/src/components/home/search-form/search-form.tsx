  ...
  return (
    ...
    >
      <div className="mb-3 sm:mb-0">
        ...
        >
          Your dream apartment, <br className="hidden sm:block" />
          at your target price
        </Text>
        <Text className="mb-5 hidden leading-6 !text-secondary sm:block 3xl:leading-8 4xl:mb-6 4xl:text-lg">
          Compare prices from thousands of providers to help you find the right
          price on the right apartment for you.
        </Text>
      </div>
      <SearchAutocomplete
        onLoad={onLoad}
